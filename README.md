...
* Donate Tokens/NFTs to winners by anyone meanwhile a raffle is open
...
```
cd existing_repo
git remote add origin https://git.ergopool.io/ergo/ergoraffle/raffle-2.git
git branch -M master
...
- [ ] [Set up project integrations](https://git.ergopool.io/ergo/ergoraffle/raffle-2/-/settings/integrations)
