...
interface TestInterface {
  ...
  serviceFeeOutputBox: OutputBuilder;
  implementerFeeOutputBox: OutputBuilder;
}
...
describe('raffleDetails', () => {
  beforeEach<TestInterface>(async (ctx) => {
    ...
    ctx.raffleDetailsBox = raffleDetailsBox;
    ctx.serviceFeeOutputBox = serviceFeeOutputBox;
    ctx.implementerFeeOutputBox = implementerFeeOutputBox;
  });
