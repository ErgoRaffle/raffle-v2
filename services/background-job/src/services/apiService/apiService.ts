...
export class ApiService extends AbstractService {
  ...
  // TODO: this is a temporary function to generate a proxy address
  // we will use proxy generator package to generate a proxy address for each request
  ...
  private registerRoutes = async (): Promise<void> => {
    ...
    registerAllRoutes(this.fastify, this.logger, this.generateProxyAddress);
  };
}
